...
async function access(userId,contentId){
  ...
  if(['FILE','IMAGE','VIDEO','AUDIO'].includes(content.type)) await delivery.logDownload({user_id:userId,content_id:content.id,order_id:ent.order_id},null);
