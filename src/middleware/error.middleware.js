...
function errorHandler(err,req,res,next){
  ...
  log(status>=500?'error':'warn','request_error',{requestId:req.id,error:err.message,stack:status>=500?err.stack:undefined,path:requestPath(req),body:redact(req.body)});
